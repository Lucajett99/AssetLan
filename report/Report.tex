...
\]
La regola per la call sarà:
\[
\infer{\Sigma \vdash f(x_1,..,x_n)[u_1,...,u_m] : \Sigma'}
{\Sigma \vdash f \;:\: \Sigma_0 \rightarrow\Sigma' \;\;\;  \Sigma'=\Sigma[a_i \rightarrow \Sigma(u_i)\oplus\Sigma(a_i)]^{i\in 1..m}\;\;\; \Sigma'[a_i \rightarrow \emptyset]^{i\in 1...m}}    
\]
