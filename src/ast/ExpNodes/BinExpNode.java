...
public class BinExpNode implements Node {
    ...
    public Node typeCheck() {
        if(op.equals("*") || op.equals("/") || op.equals("+") || op.equals("-")) {
            if(!( ((new IntTypeNode().getClass().equals(left.typeCheck().getClass()))) &&
                    (new IntTypeNode().getClass().equals(right.typeCheck().getClass())))){
            ...
            if(! (((new BoolTypeNode().getClass().equals(left.typeCheck().getClass()))) &&
                    (new BoolTypeNode().getClass().equals(right.typeCheck().getClass())))){
