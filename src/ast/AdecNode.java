        ...
        if(id != null) {
            for (IdNode idAss : id) {
                if (e.isMultipleDeclared(idAss.getId()) == EnvError.ALREADY_DECLARED) {
                    ...
                    e = Environment.addDeclaration(e, idAss.getId(), new AssetNode(idAss),null,0,false);
                }
            }
        }
        return res;
        ...
        if(id != null) {
            for (IdNode idAss : id) {
                if (e.isMultipleDeclared(idAss.getId()) == EnvError.ALREADY_DECLARED) {
                    ...
                    e = Environment.addDeclaration(e, idAss.getId(), new AssetNode(idAss),null,0,false,1);
                }
            }
        }
        return res;
